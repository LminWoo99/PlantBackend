...
public class CommentDto implements Serializable {
    ...
    public CommentDto(Long id, String content, Long tradeBoardId,Long memberId, String nickname, String isDeleted) {
        this.id = id;
    ...
    public static CommentDto convertCommentToDto(Comment comment) {
        return comment.getIsDeleted() == Y ?
                new CommentDto(comment.getId(), "삭제된 댓글입니다.", null, null,null, Y.name()) :
